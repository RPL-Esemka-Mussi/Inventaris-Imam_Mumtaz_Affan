    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-5 mt-5">
                <form action="{{ url('barang/update') }}" method="post" class="shadow p-3 mb-5 bg-body rounded">
                    @csrf
                    <h3 class="text-center mb-5">Edit Barang</h3>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" name="jumlah" id="jumlah" value="{{ $barang -> jumlah }}">
                    </div>
                    <div class="mb-3">
                        <label for="ket" class="form-label">Keterangan</label>
                        <input type="text" class="form-control" name="ket" id="ket" value="{{ $barang -> ket }}">
                    </div>
                    <div class="mb-3">
                        <label for="lokasi" class="form-label">Lokasi</label>
                        <input type="text" class="form-control" name="lokasi" id="lokasi" value="{{ $barang -> lokasi }}">
                    </div>
